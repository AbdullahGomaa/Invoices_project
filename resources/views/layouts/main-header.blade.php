								...
								@foreach (auth()->user()->unreadNotifications as $notification)
									<div class="main-notification-list Notification-scroll">
										<form action="{{ url('MarkAsRead') }}" method="Post">
											...
											<input type="hidden" name="invoice_id" value="{{ $notification->data['id']}}">

											<button type="submit" class="d-flex p-3 border-bottom w-100" style="background: none; border: none; padding: 0;">
