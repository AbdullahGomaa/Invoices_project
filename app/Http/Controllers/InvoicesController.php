...
use App\Models\User;
use App\Models\sections; // Add this line to import the 'sections' class
...
class InvoicesController extends Controller
{
  ...
  if ($request->hasFile('pic')) {
        ...
        {
            Notification::send(User::find(Auth::user()->id), new Add_invoice_new(invoices::latest()->first()));
        }

        Notification::send(User::role(['owner'])->get(), new Add_invoice_new(invoices::latest()->first()));
    ...
    {
        $products = DB::table("prds")->where("section_id", $id)->pluck("Product_name", "id");
    ...
    public function MarkAsRead(Request $request)
    {
        ...
        $details = invoices_Details::where('id_Invoice', $request->invoice_id)->get();
